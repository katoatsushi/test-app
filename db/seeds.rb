...
# ユーザー１の投稿
Event.create(:eventname =>'新入生歓迎会 by_user 1', :when => '10/4 15:00',:where => '本山駅１番出口',:user_id => '1',:text => '楽しみましょう')
Event.create(:eventname =>'履修登録説明会 by_user 1', :when => '12/24 18:00',:where => '全学部棟　C33教室',:user_id => '1',:text => '履修についてわかりやすく説明します')
Event.create(:eventname =>'成人式 by_user 1', :when => '10/4 13:00',:where => '本山駅',:user_id => '1',:text => '楽しみましょう')
Event.create(:eventname =>'歓迎会 by_user 1', :when => '10/4 4:00',:where => '１番出口',:user_id => '1',:text => '楽しみましょう')
# ユーザー２の投稿
